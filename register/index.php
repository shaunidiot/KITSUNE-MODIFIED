    ...
    <nav class="navbar navbar-inverse">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/" style="padding-top:13.5px;"><img style="height:85px;margin-top: -13px;" src="./logo.png"></img></a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
     </ul>
     <ul class="nav navbar-nav navbar-right">
       <li><a href="https://clubpenguinlite.pw/">Home</a></li>
       <li><a href="https://clubpenguinlite.pw/play/">Play</a></li>
      </ul>
   </div><!-- /.navbar-collapse -->
      </div>
    </nav>
...
$('input').keyup(function(){
  ...
  <div class="form-group">
      ...
      <div style="margin-left: -160px;" class="g-recaptcha" data-sitekey="yoursitekey"></div><br>
